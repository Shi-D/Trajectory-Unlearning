...
OUTPUT_DIR="${OUTPUT_DIR:-$CKPT_ROOT/traj_webshop_ga_${RUN_TAG}}"

PYTHONNOUSERSITE=1 torchrun --nproc_per_node="$NPROC" --standalone unlearn/ga_unlearn.py \
    ...
    --report_to_wandb \
    --run_name "traj_webshop_ga_${RUN_TAG}"
