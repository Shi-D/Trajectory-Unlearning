...
INCLUDE_TASK_KEYS_PATH="${INCLUDE_TASK_KEYS_PATH:-$COLLECTION_WEBSHOP_DIR/output/webshop_retain900_task_keys.json}"
...
export EXPERIMENT_NAME="traj_webshop_grpo_control_retain900${RUN_TAG_SUFFIX:-}"
...
exec bash "$SCRIPT_DIR/_common/webshop.sh" \
    ...
    env.webshop.include_task_keys_path="$INCLUDE_TASK_KEYS_PATH" \
