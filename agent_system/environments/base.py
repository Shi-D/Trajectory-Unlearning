...
class EnvironmentManagerBase:
    def __init__(self, envs, projection_f, config):
        ...
        self.config = config
        self._traj_use_with_memory = False

    def set_traj_use_with_memory(self, enabled: bool) -> None:
        self._traj_use_with_memory = bool(enabled)
    ...
    def step(self, text_actions: List[str]):
        ...
        next_observations = {
            ...
            'image': next_obs,
            'anchor': None # For GiGPO/Traj only. anchor observation without histories, injected skills, etc. Implement this if needed
        }
